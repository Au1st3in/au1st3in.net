                          ...
                          <div class="col s12 m6">
                            ...
                            <div class="row center">
                              <?php if($server['gq_online'] && (strpos($server['game_descr'], 'DayZ') !== false)){ ?>
                                <a href="<?php echo $dayzccPath; ?>" target="_blank" rel="noopener noreferrer" class="btn waves-effect waves-light blue-grey lighten-1"><i class="material-icons left">launch</i>Control Center</a>
                              <?php } ?>
                            </div>
                          </div>
                        </div>
            ...
            <div class="footer-copyright blue-grey darken-1">
              <div class="container grey-text text-lighten-4">
                <p class="grey-text text-lighten-4">
                  ...
                  <a class="grey-text text-lighten-4" href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank" rel="noopener noreferrer">Some Rights Reserved</a>
                  <a class="grey-text text-lighten-4 right" href="http://materializecss.com" target="_blank" rel="noopener noreferrer">Built with Materialize</a>
                </p>
              </div>
            </div>
